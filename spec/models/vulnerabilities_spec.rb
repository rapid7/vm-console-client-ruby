...
# Unit tests for Rapid7VmConsole::Vulnerabilities
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Vulnerabilities' do
  before do
    # run before each test
    @instance = Rapid7VmConsole::Vulnerabilities.new
  end
  ...
  describe 'test an instance of Vulnerabilities' do
    it 'should create an instance of Vulnerabilities' do
      expect(@instance).to be_instance_of(Rapid7VmConsole::Vulnerabilities)
    end
  end
