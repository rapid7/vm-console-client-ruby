...
# Unit tests for Rapid7VmConsole::Asset
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Asset' do
  before do
    # run before each test
    @instance = Rapid7VmConsole::Asset.new
  end
  ...
  describe 'test an instance of Asset' do
    it 'should create an instance of Asset' do
      expect(@instance).to be_instance_of(Rapid7VmConsole::Asset)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unknown", "guest", "hypervisor", "physical", "mobile"])
