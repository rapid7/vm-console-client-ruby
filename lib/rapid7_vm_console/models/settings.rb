...
module Rapid7VmConsole
  ...
  class Settings
    ...
    # Details the authentication settings.
    attr_accessor :authentication

    # Details the database settings.
    ...
    attr_accessor :insight_platform_region

    # Hypermedia links to corresponding or related resources.
    attr_accessor :links

    # Details risk configuration and settings.
    attr_accessor :risk

    # Details the global settings for scanning.
    attr_accessor :scan

    # The console serial number.
    attr_accessor :serial_number

    # Global SMTP distribution settings.
    attr_accessor :smtp

    # Details the update settings.
    attr_accessor :updates

    # The universally unique identifier (UUID) of the console.
    attr_accessor :uuid

    # Details the web server settings.
    attr_accessor :web
    ...
    def self.swagger_types
      {
        :'asset_linking' => :'BOOLEAN',
        :'authentication' => :'AuthenticationSettings',
        :'database' => :'DatabaseSettings',
        :'directory' => :'String',
        :'insight_platform' => :'BOOLEAN',
        :'insight_platform_region' => :'String',
        :'links' => :'Array<Link>',
        :'risk' => :'RiskSettings',
        :'scan' => :'ScanSettings',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assetLinking')
        self.asset_linking = attributes[:'assetLinking']
      end
      ...
      if attributes.has_key?(:'insightPlatformRegion')
        self.insight_platform_region = attributes[:'insightPlatformRegion']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          asset_linking == o.asset_linking &&
          authentication == o.authentication &&
          database == o.database &&
          directory == o.directory &&
          insight_platform == o.insight_platform &&
          insight_platform_region == o.insight_platform_region &&
          links == o.links &&
          risk == o.risk &&
          scan == o.scan &&
    ...
    def hash
      [asset_linking, authentication, database, directory, insight_platform, insight_platform_region, links, risk, scan, serial_number, smtp, updates, uuid, web].hash
    end
