...
module Rapid7VmConsole
  ...
  class WebSettings
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'maxThreads')
        self.max_threads = attributes[:'maxThreads']
      end

      if attributes.has_key?(:'minThreads')
        self.min_threads = attributes[:'minThreads']
      end
    ...
    def hash
      [max_threads, min_threads, port, session_timeout].hash
    end
