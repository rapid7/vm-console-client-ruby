...
module Rapid7VmConsole
  ...
  class User
    ...
    attr_accessor :password_reset_on_login
    ...
    def self.swagger_types
      {
        ...
        :'name' => :'String',
        :'password' => :'String',
        :'password_reset_on_login' => :'BOOLEAN',
        :'role' => :'UserCreateRole'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'passwordResetOnLogin')
        self.password_reset_on_login = attributes[:'passwordResetOnLogin']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          password == o.password &&
          password_reset_on_login == o.password_reset_on_login &&
          role == o.role
    end
    ...
    def hash
      [authentication, email, enabled, id, links, locale, locked, login, name, password, password_reset_on_login, role].hash
    end
