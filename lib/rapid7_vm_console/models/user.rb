...
module Rapid7VmConsole
  # 
  class User
    # The authentication source used to authenticate the user.
    ...
    # The privileges and role the user is assigned.
    attr_accessor :role
    ...
    def hash
      [authentication, email, enabled, id, links, locale, locked, login, name, role].hash
    end
