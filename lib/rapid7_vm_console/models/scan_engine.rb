...
module Rapid7VmConsole
  ...
  class ScanEngine
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contentVersion')
        self.content_version = attributes[:'contentVersion']
      end

      if attributes.has_key?(:'enginePools')
        if (value = attributes[:'enginePools']).is_a?(Array)
          self.engine_pools = value
        end
      end
      ...
      if attributes.has_key?(:'lastRefreshedDate')
        self.last_refreshed_date = attributes[:'lastRefreshedDate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          engine_pools == o.engine_pools &&
          id == o.id &&
          last_refreshed_date == o.last_refreshed_date &&
    ...
    def hash
      [address, content_version, engine_pools, id, last_refreshed_date, last_updated_date, links, name, port, product_version, sites].hash
    end
