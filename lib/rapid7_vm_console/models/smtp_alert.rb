...
module Rapid7VmConsole
  ...
  class SmtpAlert
    ...
    attr_accessor :limit_alert_text
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'limitAlertText')
        self.limit_alert_text = attributes[:'limitAlertText']
      end
      ...
      if attributes.has_key?(:'relayServer')
        self.relay_server = attributes[:'relayServer']
      end
    ...
    def list_invalid_properties
      ...
      if @relay_server.nil?
        invalid_properties.push("invalid value for 'relay_server', relay_server cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @relay_server.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          limit_alert_text == o.limit_alert_text &&
          links == o.links &&
          maximum_alerts == o.maximum_alerts &&
          name == o.name &&
          notification == o.notification &&
          recipients == o.recipients &&
          relay_server == o.relay_server &&
    ...
    def hash
      [enabled, enabled_scan_events, enabled_vulnerability_events, id, limit_alert_text, links, maximum_alerts, name, notification, recipients, relay_server, sender_email_address].hash
    end
