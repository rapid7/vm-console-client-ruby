...
module Rapid7VmConsole
  ...
  class LicenseReporting
    ...
    attr_accessor :customizable_csv_export
    ...
    def self.swagger_types
      {
        :'advanced' => :'BOOLEAN',
        :'customizable_csv_export' => :'BOOLEAN',
        :'pci' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'advanced')
        self.advanced = attributes[:'advanced']
      end

      if attributes.has_key?(:'customizableCSVExport')
        self.customizable_csv_export = attributes[:'customizableCSVExport']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          advanced == o.advanced &&
          customizable_csv_export == o.customizable_csv_export &&
          pci == o.pci
    end
    ...
    def hash
      [advanced, customizable_csv_export, pci].hash
    end
