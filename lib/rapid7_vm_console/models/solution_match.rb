...
module Rapid7VmConsole
  ...
  class SolutionMatch
    ...
    # The fingerprint used to perform solution matching, if type is `operating-system`, `service`, or `software`.
    ...
    def valid?
      confidence_validator = EnumAttributeValidator.new('String', ["exact", "partial", "none"])
      return false unless confidence_validator.valid?(@confidence)
      type_validator = EnumAttributeValidator.new('String', ["none", "check", "operating-system", "service", "software"])
    ...
    def confidence=(confidence)
      validator = EnumAttributeValidator.new('String', ["exact", "partial", "none"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["none", "check", "operating-system", "service", "software"])
    ...
    def hash
      [check, confidence, fingerprint, links, solution, type].hash
    end
