...
module Rapid7VmConsole
  ...
  class UpdateInfo
    ...
    attr_accessor :content_partial

    # Details of update identifiers.
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contentPartial')
        self.content_partial = attributes[:'contentPartial']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          content == o.content &&
          content_partial == o.content_partial &&
          id == o.id &&
          product == o.product
    end
    ...
    def hash
      [content, content_partial, id, product].hash
    end
