...
module Rapid7VmConsole
  ...
  class AssetVulnerabilities
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'exploits')
        self.exploits = attributes[:'exploits']
      end

      if attributes.has_key?(:'malwareKits')
        self.malware_kits = attributes[:'malwareKits']
      end

      if attributes.has_key?(:'moderate')
        self.moderate = attributes[:'moderate']
      end

      if attributes.has_key?(:'severe')
        self.severe = attributes[:'severe']
      end
    ...
    def hash
      [critical, exploits, malware_kits, moderate, severe, total].hash
    end
