...
module Rapid7VmConsole
  ...
  class WebPage
    ...
    def valid?
      link_type_validator = EnumAttributeValidator.new('String', ['seed', 'html-ref', 'robots', 'js-string', 'query-param', 'pdf', 'css', 'implied-dir', 'rss', 'redirection', 'sitemap', 'backup', 'vck-rewrite', 'non-ref-guess', 'soft-404'])
    ...
    def link_type=(link_type)
      validator = EnumAttributeValidator.new('String', ['seed', 'html-ref', 'robots', 'js-string', 'query-param', 'pdf', 'css', 'implied-dir', 'rss', 'redirection', 'sitemap', 'backup', 'vck-rewrite', 'non-ref-guess', 'soft-404'])
