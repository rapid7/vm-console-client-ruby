...
module Rapid7VmConsole
  ...
  class ScanTemplateDatabase
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'db2')
        self.db2 = attributes[:'db2']
      end
      ...
      if attributes.has_key?(:'oracle')
        if (value = attributes[:'oracle']).is_a?(Array)
          self.oracle = value
        end
      end

      if attributes.has_key?(:'postgres')
        self.postgres = attributes[:'postgres']
      end
    end
    ...
    def hash
      [db2, links, oracle, postgres].hash
    end
