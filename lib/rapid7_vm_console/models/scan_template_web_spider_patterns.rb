...
module Rapid7VmConsole
  ...
  class ScanTemplateWebSpiderPatterns
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sensitiveContent')
        self.sensitive_content = attributes[:'sensitiveContent']
      end

      if attributes.has_key?(:'sensitiveField')
        self.sensitive_field = attributes[:'sensitiveField']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          sensitive_content == o.sensitive_content &&
          sensitive_field == o.sensitive_field
    end
    ...
    def hash
      [sensitive_content, sensitive_field].hash
    end
