...
module Rapid7VmConsole
  ...
  class PolicyControl
    ...
    attr_accessor :cce_item_id

    # The platform of the CCE.
    attr_accessor :cce_platform
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cceItemId')
        self.cce_item_id = attributes[:'cceItemId']
      end

      if attributes.has_key?(:'ccePlatform')
        self.cce_platform = attributes[:'ccePlatform']
      end

      if attributes.has_key?(:'controlName')
        self.control_name = attributes[:'controlName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cce_item_id == o.cce_item_id &&
          cce_platform == o.cce_platform &&
    ...
    def hash
      [cce_item_id, cce_platform, control_name, id, links, published_date].hash
    end
