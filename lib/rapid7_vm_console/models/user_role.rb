...
module Rapid7VmConsole
  ...
  class UserRole
    ...
    attr_accessor :all_asset_groups
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allAssetGroups')
        self.all_asset_groups = attributes[:'allAssetGroups']
      end

      if attributes.has_key?(:'allSites')
        self.all_sites = attributes[:'allSites']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          all_asset_groups == o.all_asset_groups &&
    ...
    def hash
      [all_asset_groups, all_sites, id, name, privileges, superuser].hash
    end
