...
module Rapid7VmConsole
  ...
  class DiscoverySearchCriteria
    ...
    def self.swagger_types
      {
        ...
        :'filters' => :'Array<SwaggerDiscoverySearchCriteriaFilter>',
        :'match' => :'String'
      }
    end
    ...
    def valid?
      ...
      match_validator = EnumAttributeValidator.new('String', ['any', 'all'])
      return false unless match_validator.valid?(@match)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] match Object to be assigned
    def match=(match)
      validator = EnumAttributeValidator.new('String', ['any', 'all'])
      unless validator.valid?(match)
        fail ArgumentError, 'invalid value for "match", must be one of #{validator.allowable_values}.'
      end
      @match = match
    end
    ...
    def hash
      [connection_type, filters, match].hash
    end
