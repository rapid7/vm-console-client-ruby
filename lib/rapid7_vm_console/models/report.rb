...
module Rapid7VmConsole
  ...
  class Report
    ...
    def hash
      [bureau, component, database, email, enclave, filters, format, frequency, id, language, links, name, organization, owner, policy, query, scope, storage, template, timezone, users, version].hash
    end
