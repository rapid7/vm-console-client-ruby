...
module Rapid7VmConsole
  ...
  class ExceptionScope
    # The identifier of the scope type to which the exception applies. For example in a site scoped vulnerability exception this is the site id, in an asset group vulnerability exception this is the asset group id.
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vulnerability')
    ...
    def hash
      [id, key, links, port, type, vulnerability].hash
    end
