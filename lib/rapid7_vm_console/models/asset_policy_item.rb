...
module Rapid7VmConsole
  ...
  class AssetPolicyItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hasOverride')
        self.has_override = attributes[:'hasOverride']
      end
      ...
      if attributes.has_key?(:'isUnscored')
        self.is_unscored = attributes[:'isUnscored']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["rule", "group"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["rule", "group"])
