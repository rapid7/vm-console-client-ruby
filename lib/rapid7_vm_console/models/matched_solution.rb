...
module Rapid7VmConsole
  ...
  class MatchedSolution
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'estimate')
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["configuration", "rollup-patch", "patch", "unknown"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["configuration", "rollup-patch", "patch", "unknown"])
    ...
    def hash
      [additional_information, applies_to, confidence, estimate, id, links, matches, steps, summary, type].hash
    end
