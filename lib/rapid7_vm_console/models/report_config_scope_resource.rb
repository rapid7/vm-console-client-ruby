...
module Rapid7VmConsole
  ...
  class ReportConfigScopeResource
    ...
    def self.swagger_types
      {
        :'asset_groups' => :'Array<Integer>',
        :'assets' => :'Array<Integer>',
        :'scan' => :'Integer',
        :'sites' => :'Array<Integer>',
        :'tags' => :'Array<Integer>'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assetGroups')
        if (value = attributes[:'assetGroups']).is_a?(Array)
          self.asset_groups = value
        end
      end
    ...
    def hash
      [asset_groups, assets, scan, sites, tags].hash
    end
