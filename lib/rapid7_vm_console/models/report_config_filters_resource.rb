...
module Rapid7VmConsole
  ...
  class ReportConfigFiltersResource
    ...
    def valid?
      severity_validator = EnumAttributeValidator.new('String', ['all', 'critical', 'critical-and-severe'])
    ...
    def severity=(severity)
      validator = EnumAttributeValidator.new('String', ['all', 'critical', 'critical-and-severe'])
    ...
    def hash
      [categories, severity, statuses].hash
    end
