...
module Rapid7VmConsole
  ...
  class ReportConfigDatabaseResource
    ...
    def valid?
      vendor_validator = EnumAttributeValidator.new('String', ['oracle', 'mssql', 'mysql'])
    ...
    def vendor=(vendor)
      validator = EnumAttributeValidator.new('String', ['oracle', 'mssql', 'mysql'])
    ...
    def hash
      [credentials, host, name, port, vendor].hash
    end
