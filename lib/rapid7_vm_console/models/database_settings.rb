...
module Rapid7VmConsole
  ...
  class DatabaseSettings
    # Details connection settings for the database.
    ...
    attr_accessor :maintenance_thread_pool_size
    ...
    def self.swagger_types
      {
        ...
        :'host' => :'String',
        :'maintenance_thread_pool_size' => :'Integer',
        :'port' => :'Integer',
        :'url' => :'String',
        :'user' => :'String',
        :'vendor' => :'String'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'maintenanceThreadPoolSize')
        self.maintenance_thread_pool_size = attributes[:'maintenanceThreadPoolSize']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          host == o.host &&
          maintenance_thread_pool_size == o.maintenance_thread_pool_size &&
          port == o.port &&
          url == o.url &&
          user == o.user &&
          vendor == o.vendor
    ...
    def hash
      [connection, host, maintenance_thread_pool_size, port, url, user, vendor].hash
    end
