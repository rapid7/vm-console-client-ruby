...
module Rapid7VmConsole
  ...
  class SonarCriterion
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lower')
        self.lower = attributes[:'lower']
      end

      if attributes.has_key?(:'searchDomain')
        self.search_domain = attributes[:'searchDomain']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['domain-contains', 'scan-date-within-the-last', 'ip-address-range'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['domain-contains', 'scan-date-within-the-last', 'ip-address-range'])
    ...
    def hash
      [days, lower, search_domain, type, upper].hash
    end
