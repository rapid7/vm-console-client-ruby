...
module Rapid7VmConsole
  ...
  class SiteSharedCredential
    ...
    def valid?
      service_validator = EnumAttributeValidator.new('String', ['as400', 'cifs', 'cifshash', 'cvs', 'db2', 'ftp', 'http', 'ms-sql', 'mysql', 'notes', 'oracle', 'pop', 'postgresql', 'remote-exec', 'snmp', 'snmpv3', 'ssh', 'ssh-key', 'sybase', 'telnet'])
    ...
    def service=(service)
      validator = EnumAttributeValidator.new('String', ['as400', 'cifs', 'cifshash', 'cvs', 'db2', 'ftp', 'http', 'ms-sql', 'mysql', 'notes', 'oracle', 'pop', 'postgresql', 'remote-exec', 'snmp', 'snmpv3', 'ssh', 'ssh-key', 'sybase', 'telnet'])
    ...
    def hash
      [enabled, id, links, name, service].hash
    end
