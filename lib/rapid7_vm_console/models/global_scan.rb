...
module Rapid7VmConsole
  ...
  class GlobalScan
    ...
    def hash
      [assets, duration, end_time, engine_id, engine_name, id, links, message, scan_name, scan_type, site_id, site_name, start_time, started_by, status, vulnerabilities].hash
    end
