...
module Rapid7VmConsole
  ...
  class License
    ...
    # The features available in the license.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'perpetual')
        self.perpetual = attributes[:'perpetual']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["Activated", "Unlicensed", "Expired", "Evaluation Mode", "Revoked", "Unknown"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Activated", "Unlicensed", "Expired", "Evaluation Mode", "Revoked", "Unknown"])
    ...
    def hash
      [edition, evaluation, expires, features, limits, links, perpetual, status].hash
    end
