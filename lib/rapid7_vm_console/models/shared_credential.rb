...
module Rapid7VmConsole
  ...
  class SharedCredential
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'siteAssignment')
        self.site_assignment = attributes[:'siteAssignment']
      end
    ...
    def list_invalid_properties
      ...
      if @site_assignment.nil?
        invalid_properties.push('invalid value for "site_assignment", site_assignment cannot be nil.')
      end
