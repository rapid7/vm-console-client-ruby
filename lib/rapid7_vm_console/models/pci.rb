...
module Rapid7VmConsole
  ...
  class PCI
    ...
    def self.swagger_types
      {
        :'adjusted_cvss_score' => :'Integer',
        :'adjusted_severity_score' => :'Integer',
        :'fail' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'adjustedCVSSScore')
        self.adjusted_cvss_score = attributes[:'adjustedCVSSScore']
      end

      if attributes.has_key?(:'adjustedSeverityScore')
        self.adjusted_severity_score = attributes[:'adjustedSeverityScore']
      end

      if attributes.has_key?(:'fail')
        self.fail = attributes[:'fail']
      end

      if attributes.has_key?(:'specialNotes')
        self.special_notes = attributes[:'specialNotes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          adjusted_cvss_score == o.adjusted_cvss_score &&
          adjusted_severity_score == o.adjusted_severity_score &&
          fail == o.fail &&
    ...
    def hash
      [adjusted_cvss_score, adjusted_severity_score, fail, special_notes, status].hash
    end
