...
module Rapid7VmConsole
  ...
  class Policy
    ...
    attr_accessor :recursive_windows_fs_search
    ...
    def self.swagger_types
      {
        :'enabled' => :'Array<Integer>',
        :'links' => :'Array<Link>',
        :'recursive_windows_fs_search' => :'BOOLEAN',
        :'store_scap' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'recursiveWindowsFSSearch')
        self.recursive_windows_fs_search = attributes[:'recursiveWindowsFSSearch']
      end

      if attributes.has_key?(:'storeSCAP')
        self.store_scap = attributes[:'storeSCAP']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enabled == o.enabled &&
          links == o.links &&
          recursive_windows_fs_search == o.recursive_windows_fs_search &&
          store_scap == o.store_scap
    end
    ...
    def hash
      [enabled, links, recursive_windows_fs_search, store_scap].hash
    end
