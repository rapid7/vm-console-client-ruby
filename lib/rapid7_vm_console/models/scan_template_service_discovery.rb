...
module Rapid7VmConsole
  ...
  class ScanTemplateServiceDiscovery
    ...
    attr_accessor :service_name_file
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'serviceNameFile')
        self.service_name_file = attributes[:'serviceNameFile']
      end

      if attributes.has_key?(:'tcp')
        self.tcp = attributes[:'tcp']
      end

      if attributes.has_key?(:'udp')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          service_name_file == o.service_name_file &&
          tcp == o.tcp &&
          udp == o.udp
    end
    ...
    def hash
      [service_name_file, tcp, udp].hash
    end
