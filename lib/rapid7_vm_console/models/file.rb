...
module Rapid7VmConsole
  ...
  class File
    ...
    def self.swagger_types
      {
        :'attributes' => :'Array<Configuration>',
        :'name' => :'String',
        :'size' => :'Integer',
        :'type' => :'String'
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['file', 'directory'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['file', 'directory'])
    ...
    def hash
      [attributes, name, size, type].hash
    end
