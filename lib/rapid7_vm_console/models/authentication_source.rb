...
module Rapid7VmConsole
  ...
  class AuthenticationSource
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['normal', 'kerberos', 'ldap', 'saml', 'admin'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['normal', 'kerberos', 'ldap', 'saml', 'admin'])
    ...
    def hash
      [external, id, links, name, type].hash
    end
