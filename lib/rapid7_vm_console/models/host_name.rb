...
module Rapid7VmConsole
  ...
  class HostName
    ...
    def valid?
      ...
      source_validator = EnumAttributeValidator.new('String', ['user', 'dns', 'netbios', 'dce', 'epsec', 'ldap', 'other'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ['user', 'dns', 'netbios', 'dce', 'epsec', 'ldap', 'other'])
