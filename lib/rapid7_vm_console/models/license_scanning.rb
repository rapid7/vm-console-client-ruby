...
module Rapid7VmConsole
  ...
  class LicenseScanning
    ...
    # Details as to whether policy scanning and what benchmarks are available.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scada')
        self.scada = attributes[:'scada']
      end
      ...
      if attributes.has_key?(:'webApplication')
        self.web_application = attributes[:'webApplication']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scada == o.scada &&
          virtual == o.virtual &&
          web_application == o.web_application
    end
    ...
    def hash
      [discovery, policy, scada, virtual, web_application].hash
    end
