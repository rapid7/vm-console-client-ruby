...
module Rapid7VmConsole
  # 
  class InstallSize
    # The disk space used by backups.
    attr_accessor :backups

    # The disk space used by the database.
    attr_accessor :database

    # The installation directory.
    attr_accessor :directory

    # The disk space used by reports.
    attr_accessor :reports

    # The disk space used by scans.
    attr_accessor :scans

    # Total disk space used by the installation.
    attr_accessor :total
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scans')
        self.scans = attributes[:'scans']
      end
    ...
    def hash
      [backups, database, directory, reports, scans, total].hash
    end
