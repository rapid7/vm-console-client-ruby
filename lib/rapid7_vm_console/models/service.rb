...
module Rapid7VmConsole
  ...
  class Service
    ...
    attr_accessor :web_applications
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'webApplications')
        if (value = attributes[:'webApplications']).is_a?(Array)
          self.web_applications = value
        end
      end
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ["ip", "icmp", "igmp", "ggp", "tcp", "pup", "udp", "idp", "esp", "nd", "raw"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vendor == o.vendor &&
          version == o.version &&
          web_applications == o.web_applications
    end
    ...
    def hash
      [configurations, databases, family, links, name, port, product, protocol, user_groups, users, vendor, version, web_applications].hash
    end
