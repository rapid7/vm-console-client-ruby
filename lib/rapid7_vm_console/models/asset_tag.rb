...
module Rapid7VmConsole
  ...
  class AssetTag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'riskModifier')
        self.risk_modifier = attributes[:'riskModifier']
      end

      if attributes.has_key?(:'searchCriteria')
    ...
    def valid?
      color_validator = EnumAttributeValidator.new('String', ["default", "blue", "green", "orange", "red", "purple"])
      return false unless color_validator.valid?(@color)
      return false if @name.nil?
      source_validator = EnumAttributeValidator.new('String', ["built-in", "custom"])
      return false unless source_validator.valid?(@source)
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["custom", "location", "owner", "criticality"])
    ...
    def color=(color)
      validator = EnumAttributeValidator.new('String', ["default", "blue", "green", "orange", "red", "purple"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["custom", "location", "owner", "criticality"])
    ...
    def hash
      [color, created, id, links, name, risk_modifier, search_criteria, source, sources, type].hash
    end
