...
module Rapid7VmConsole
  ...
  class RiskModifierSettings
    ...
    attr_accessor :very_high

    # ${settings.risk.modifier.veryLow}
    attr_accessor :very_low
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'veryHigh')
        self.very_high = attributes[:'veryHigh']
      end

      if attributes.has_key?(:'veryLow')
        self.very_low = attributes[:'veryLow']
      end
    end
    ...
    def hash
      [high, low, medium, very_high, very_low].hash
    end
