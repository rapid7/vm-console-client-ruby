...
module Rapid7VmConsole
  ...
  class SharedCredentialAccount
    ...
    attr_accessor :permission_elevation_user_name
    ...
    def self.swagger_types
      {
        ...
        :'permission_elevation_user_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'permissionElevationUserName')
        self.permission_elevation_user_name = attributes[:'permissionElevationUserName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          permission_elevation_user_name == o.permission_elevation_user_name &&
