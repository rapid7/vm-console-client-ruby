...
module Rapid7VmConsole
  ...
  class Site
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastScanTime')
        self.last_scan_time = attributes[:'lastScanTime']
      end
      ...
      if attributes.has_key?(:'scanEngine')
        self.scan_engine = attributes[:'scanEngine']
      end

      if attributes.has_key?(:'scanTemplate')
        self.scan_template = attributes[:'scanTemplate']
      end
    ...
    def valid?
      connection_type_validator = EnumAttributeValidator.new('String', ["activesync-ldap", "activesync-office365", "activesync-powershell", "aws", "dhcp", "sonar", "vsphere"])
      return false unless connection_type_validator.valid?(@connection_type)
      type_validator = EnumAttributeValidator.new('String', ["agent", "dynamic", "static"])
    ...
    def connection_type=(connection_type)
      validator = EnumAttributeValidator.new('String', ["activesync-ldap", "activesync-office365", "activesync-powershell", "aws", "dhcp", "sonar", "vsphere"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["agent", "dynamic", "static"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scan_engine == o.scan_engine &&
          scan_template == o.scan_template &&
          type == o.type &&
    ...
    def hash
      [assets, connection_type, description, id, importance, last_scan_time, links, name, risk_score, scan_engine, scan_template, type, vulnerabilities].hash
    end
