...
module Rapid7VmConsole
  ...
  class TagAssetSource
    ...
    def valid?
      source_validator = EnumAttributeValidator.new('String', ['site', 'asset-group', 'criteria', 'tag', 'unknown'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ['site', 'asset-group', 'criteria', 'tag', 'unknown'])
