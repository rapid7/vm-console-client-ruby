...
module Rapid7VmConsole
  ...
  class LicensePolicyScanningBenchmarks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'disa')
        self.disa = attributes[:'disa']
      end

      if attributes.has_key?(:'fdcc')
        self.fdcc = attributes[:'fdcc']
      end

      if attributes.has_key?(:'usgcb')
        self.usgcb = attributes[:'usgcb']
      end
    end
    ...
    def hash
      [cis, custom, disa, fdcc, usgcb].hash
    end
