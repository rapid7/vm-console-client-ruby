...
module Rapid7VmConsole
  ...
  class SiteUpdateResource
    ...
    def list_invalid_properties
      ...
      if @scan_template_id.nil?
        invalid_properties.push("invalid value for 'scan_template_id', scan_template_id cannot be nil.")
      end
    ...
    def valid?
      ...
      importance_validator = EnumAttributeValidator.new('String', ["very_low", "low", "normal", "high", "very_high"])
      return false unless importance_validator.valid?(@importance)
      return false if @name.nil?
      return false if @scan_template_id.nil?
      return true
    end
    ...
    def importance=(importance)
      validator = EnumAttributeValidator.new('String', ["very_low", "low", "normal", "high", "very_high"])
      unless validator.valid?(importance)
        fail ArgumentError, "invalid value for 'importance', must be one of #{validator.allowable_values}."
      end
      @importance = importance
    end
    ...
    def hash
      [description, engine_id, importance, links, name, scan_template_id].hash
    end
