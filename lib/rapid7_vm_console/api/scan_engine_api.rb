...
module Rapid7VmConsole
  class ScanEngineApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ScanEngine] :param0 The specification of a scan engine.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [EnginePool] :param0 The details for the scan engine to update.
    ...
    # @param id The identifier of the engine pool.
    # @param [Hash] opts the optional parameters
    # @option opts [Array<Integer>] :param1 The identifiers of the scan engines to place into the engine pool.
    # @return [Links]
    ...
    # @param id The identifier of the scan engine.
    # @param [Hash] opts the optional parameters
    # @option opts [ScanEngine] :param1 The specification of the scan engine to update.
    # @return [Links]
    ...
    # @param id The identifier of the engine pool.
    # @param [Hash] opts the optional parameters
    # @option opts [EnginePool] :param1 The details for the scan engine to update.
    # @return [Links]
