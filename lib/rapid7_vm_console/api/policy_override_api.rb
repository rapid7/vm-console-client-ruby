...
module Rapid7VmConsole
  class PolicyOverrideApi
    ...
    # @option opts [PolicyOverride] :param0 The specification of a policy override. Allows users to override the compliance result of a policy rule.
    ...
    # @param id The identifier of the policy override.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :param1 The date the policy override is set to expire. Date is represented in ISO 8601 format.
    # @return [Links]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :param2 A comment describing the change of the policy override status.
    # @return [nil]
